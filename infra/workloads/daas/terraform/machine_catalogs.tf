module "machine_catalogs" {
  ...
  prepared_image_definition_name_override = try(each.value.prepared_image_definition_name_override, null)
  machine_name_prefix_override            = try(each.value.machine_name_prefix_override, null)
